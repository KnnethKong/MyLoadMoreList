 ...
 */
public class RecyclerLoadView extends RecyclerView {
    ...
    public RecyclerLoadView(Context context) {
        super(context);
        initView();
    }

    public RecyclerLoadView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public RecyclerLoadView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView();
    }

    public void initView() {
        View headerView = LayoutInflater.from(getContext()).inflate(R.layout.load_head_layout, null);
        View footerView = LayoutInflater.from(getContext()).inflate(R.layout.load_footer_layout, null);
        addHeaderView(headerView);
        addFooterView(footerView);
    }

    public void initListener() {
        text = (TextView) getHeaderView(0).findViewById(R.id.head_txt);
